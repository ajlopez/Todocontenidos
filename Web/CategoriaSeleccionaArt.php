<?php
	...
	$Subparametros = "IdArticulo=$IdArticulo&IdCategoriaArticulo=$IdCategoriaArticulo";
...
?>
<p>
<a href="CategoriaArticuloGraba.php?<? echo $Parametros; ?>">Selecciona esta Categor&iacute;a</a>
</p>
<p>
<a href="CategoriaSeleccionaArt.php?<? echo $Subparametros ?>">Categor&iacute;as</a>
<?php
	if ($IdPadre) {
		echo "&nbsp;->&nbsp;";
		echo CategoriasEnlaces($IdPadre,"CategoriaSeleccionaArt.php?$Subparametros","IdCategoria");
	}
?>
</p>
<?php
...
function MuestraCategoria($Id,$Descripcion,$Resumen,$x,$y)
{
	...
	echo "<td width='33%' height=30 class=categoria valign=top bgcolor=$fondo><a class=categoria href='CategoriaSeleccionaArt.php?IdCategoria=$Id&$Subparametros'>$Descripcion</a><br>$Resumen</td>\n";
}
