<?
	...
	if ($IdCategoria) {
		$rsCategoria = mysql_query("select Descripcion from cursoscategorias where Id = $IdCategoria order by Descripcion");
		list($CatDescripcion)=mysql_fetch_row($rsCategoria);
		mysql_free_result($rsCategoria);
		$PaginaTitulo = "Cursos $CatDescripcion";
	}
	else {
...
&nbsp;&nbsp;
<a href="CursosGratuitos.php">Cursos Gratuitos</a>
</p>
<?
	}
?>
