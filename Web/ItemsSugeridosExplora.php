<?
	...
	$PaginaTitulo = "Items Sugeridos";

	AdministradorControla();

	Conectar();

	$sql = "Select * from itemssugeridos";
	...
	$titulos = array("Id", "Descripci&oacute;n", "Detalle", "Enlace", "Orden","Usuario","Categor&iacute;a","Fecha/Hora Alta");
...
<p>
<a href="ItemsSugeridosExplora.php?Desde=0<? echo $Parametros; ?>">Inicio</a>
&nbsp;&nbsp;
<a href="ItemsSugeridosExplora.php?Desde=<? echo $Anterior; ?><? echo $Parametros; ?>">Anterior</a>
&nbsp;&nbsp;
<a href="ItemsSugeridosExplora.php?Desde=<? echo $Siguiente; ?><? echo $Parametros; ?>">Siguiente</a>
&nbsp;&nbsp;
<a href="ItemsSugeridosExplora.php?Desde=<? echo $Ultimo; ?><? echo $Parametros; ?>">Final</a>
&nbsp;&nbsp;
...
function MuestraRegistro($reg) {
	FilaInicio();
	DatoEnlaceNuevoGenera($reg["Id"], "ItemSugerido.php?Id=".$reg["Id"]);
	...
	if ($reg["IdCategoria"]) {
		CategoriaTraduce($reg["IdCategoria"], $CategoriaDescripcion,$IdCategoriaPadre);
		DatoEnlaceGenera($CategoriaDescripcion, "Categoria.php?Id=".$reg["IdCategoria"]);
	}
	else {
		DatoGenera('');
	}
